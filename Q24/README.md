...
* Seperate the entire word into two arrays, one for the unshuffled characters with respect to the test case and other for the shuffled characters which comprises the entities from the position where the given number exceeds the factorial
